...
#pragma mark DatabaseViewController


- (FMResultSet *)executeQueryFromViewController:(NSString*)sql, ...
{
    va_list args;
    va_start(args, sql);
    
    id result = [self executeQueryFromViewController:sql withArgumentsInArray:nil orDictionary:nil orVAList:args];
    
    va_end(args);
    return result;
}

- (FMResultSet *)executeQueryFromViewController:(NSString *)sql withArgumentsInArray:(NSArray*)arrayArgs orDictionary:(NSDictionary *)dictionaryArgs orVAList:(va_list)args {
...
#pragma mark PrintGRoupDetails
- (FMResultSet *)executeQueryFromPrintGroupViewController:(NSString*)sql, ...
{
    va_list args;
    va_start(args, sql);
    
    id result = [self executeQueryFromPrintGroupViewController:sql withArgumentsInArray:nil orDictionary:nil orVAList:args];
    
    va_end(args);
    return result;
}

- (FMResultSet *)executeQueryFromPrintGroupViewController:(NSString *)sql withArgumentsInArray:(NSArray*)arrayArgs orDictionary:(NSDictionary *)dictionaryArgs orVAList:(va_list)args {
...
#pragma mark Favorite Database

- (FMResultSet *)executeQueryFromFavoriteController:(NSString*)sql, ...
{
    va_list args;
    va_start(args, sql);
    
    id result = [self executeQueryFromFavoriteController:sql withArgumentsInArray:nil orDictionary:nil orVAList:args];
...
- (FMResultSet *)executeQueryFromFavoriteController:(NSString *)sql withArgumentsInArray:(NSArray*)arrayArgs orDictionary:(NSDictionary *)dictionaryArgs orVAList:(va_list)args {
